...
class LaporanController extends Controller
{
    ...
    private function laporanIndikatorMelebihiBaku($tahun = null, $lokasi_id = null, $periode = null, $indikator_id = null)
    {
        $q = DB::table('hasil_uji')
            ...
            // Parameter maksimum: nilai > baku mutu = melanggar
            // Parameter minimum (DO): nilai < baku mutu = melanggar
            ->where(function ($q) {
                $q->where(function ($q) {
    ...
    // ✅ Tidak perlu diubah — hanya menampilkan rata-rata nilai
    // ============================================================
    ...
    // ✅ Tidak perlu diubah — IP sudah menggunakan rasio CI/Lij
    // ============================================================
    ...
    // ✅ Tidak perlu diubah — STORET sudah pakai skor per parameter
    // ============================================================
    private function laporanStoret($tahun = null, $periode = null, $lokasi_id = null)
    {
        ...
        foreach ($grouped as $rows) {
            ...
            foreach ($rows as $row) {
                ...
                $melanggar = $isDO
                    ? ($row->nilai < $row->baku_mutu)  // DO: melanggar jika KURANG dari baku mutu
                    : ($row->nilai > $row->baku_mutu); // Lainnya: melanggar jika LEBIH dari baku mutu
