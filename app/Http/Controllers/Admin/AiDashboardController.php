...
class AiDashboardController extends Controller
{
    ...
    public function forecast(Request $request)
    {
        ...
        if ($lokasi_id) $query->where('observasi.location_id', $lokasi_id);
        if ($parameter) $query->where('indikator_uji.nama_indikator', $parameter);
    ...
    public function correlation(Request $request)
    {
        ...
        if ($lokasi_id) $query->where('observasi.location_id', $lokasi_id);
        if ($periode)   $query->where('observasi.periode_pemantauan', $periode);
