    ...
    <div class="card-body">
        ...
        <table class="table table-bordered mb-4">
            ...
            <tr>
                ...
                <td>{{ \Carbon\Carbon::parse($observasi->tanggal_pemantauan)->locale('id')->translatedFormat('d F Y') }}</td>
            </tr>
            <tr>
                <th>SHU</th>
                <td>{{ $observasi->shu }}</td>
            ...
            <tr>
                ...
                <td>
                    @if($dataHasil->first() && $dataHasil->first()->file_berkas)
                        <a href="{{ asset('storage/'.$dataHasil->first()->file_berkas) }}" 
                           target="_blank" 
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>{{ (float) $hasil->indikator->baku_mutu }}</td>
                    <td>
                        @if($hasil->nilai <= $hasil->indikator->baku_mutu)
