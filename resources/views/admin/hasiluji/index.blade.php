...
@section('content')
    <div class="d-flex justify-content-between mb-4">
        <h1 class="h3">Data Hasil Uji</h1>
        <a href="{{ route('admin.hasiluji.create') }}" class="btn btn-primary">
                            ...
                            <tr>
                                <td>
                                    ...
                                    <small class="text-muted">
                                        ...
                                        <strong>{{ $obs->user->nama ?? 'Tidak Diketahui' }}</strong>
                                    </small><br>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('admin.hasiluji.show', $firstItem->id) }}"
                                        class="btn btn-info btn-sm mb-1" title="Detail">
                                        Detail
                                    </a>
                                    <a href="{{ route('admin.hasiluji.edit', $firstItem->observasi_id) }}"
